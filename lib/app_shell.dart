        ...
        return MaterialApp(
          ...
          home: AnimatedTheme(
            ...
            child: Builder(
              builder: (shellCtx) {
                return Scaffold(
                  backgroundColor: Theme.of(shellCtx).scaffoldBackgroundColor,
                  resizeToAvoidBottomInset: true,
                  body: SafeArea(
                    child: Column(
                      children: [
                        if (!_hidesChrome(v)) _Header(controller),
                        Expanded(
                        ...
                        if (!_hidesChrome(v))
                          BottomNavRail(
                            ...
                            moreActive: NexusFlutterApp._moreTabActive(v),
                          ),
                      ],
                    ),
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          GestureDetector(
            onTap: () => controller.navigate(ViewState.account),
            child: Container(
              width: 32,
              height: 32,
                ...
                children: [
                  ...
                  Expanded(
                    child: ShaderMask(
                      ...
                      shaderCallback: (bounds) => NexusPalette
          ...
          Stack(
            ...
            children: [
              _HeaderIconButton(
                ...
                activeColor: NexusPalette.cyan,
                onPressed: () => controller.navigate(ViewState.notifications),
              ),
...
class BottomNavRail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: surface.withValues(alpha: 0.96),
        border: Border(top: BorderSide(color: muted.withValues(alpha: .22))),
      ),
      child: Row(
        ...
        children: [
          ...
          _NavIcon(
            ...
            onTap: () => controller.navigate(ViewState.builder),
          ),
          _NavIcon(
            label: 'COMPARE',
            ...
            onTap: () => controller.navigate(ViewState.compare),
          ),
          _NavIcon(
            label: 'SAVED',
            ...
            onTap: () => controller.navigate(ViewState.favorites),
          ),
          _NavIcon(
            label: 'MORE',
        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              child: Icon(icon, size: 22, color: iconTone()),
            ),
