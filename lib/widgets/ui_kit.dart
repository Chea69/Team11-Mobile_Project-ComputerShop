      ...
      builder: (context, constraints) {
        ...
        return ShaderMask(
          ...
          shaderCallback: (bounds) =>
              NexusPalette.textGradientHorizontal.createShader(bounds),
          child: Text(
            text,
            style: base,
            textAlign: textAlign,
...
class GlowDot extends StatelessWidget {
  const GlowDot({super.key, required this.color, this.radius = 4});
      ...
      child: CustomPaint(
        ...
        child: Padding(
          ...
          child: DecoratedBox(
            decoration: BoxDecoration(
              color: inner,
              borderRadius: BorderRadius.circular(math.max(radius - 1, 0)),
            ),
            child: child,
          ),
        ),
