...
class InfiniteBrandMarquee extends StatefulWidget {
  const InfiniteBrandMarquee({
    ...
    this.velocityPixelsPerSecond = 28,
  });
...
class _InfiniteBrandMarqueeState extends State<InfiniteBrandMarquee>
                ...
                Expanded(
                  child: Text(
                    ...
                    style: labelStyle.copyWith(
                      color: accent?.withValues(alpha: .95) ?? labelStyle.color,
                    ),
                  ),
                ),
              ],
  ...
  Widget _buildChipRow(
    ...
    final n = marqueeBrands.length * InfiniteBrandMarquee.copies;
    return Row(
      key: _rowKey,
      ...
      children: [
        for (var i = 0; i < n; i++)
          _pill(
            context,
            marqueeBrands[i % marqueeBrands.length],
            labelStyle,
            muted,
          ),
      ],
