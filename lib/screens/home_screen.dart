...
class _NexusHomeScreenState extends State<NexusHomeScreen> {
  ...
  void _stepHero(int delta) {
    ...
    if (_listController.hasClients &&
        _listController.position.isScrollingNotifier.value) {
      return;
    }
    final len = heroSlides.length;
    if (len == 0) return;
  ...
  Widget build(BuildContext context) {
    ...
    final border = Theme.of(context).dividerColor.withValues(alpha: .5);
    final iconMuted = Theme.of(
      context,
    ...
    return ListView(
      ...
      children: [
            ...
            children: [
              AnimatedSwitcher(
                ...
                child: Builder(
                  ...
                  builder: (context) {
                    final slide = heroSlides[heroIndex];
                    return Stack(
                      fit: StackFit.expand,
                      children: [
                        NexusNetworkImage(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: active
                              ? [
                                  BoxShadow(
                                    blurRadius: 12,
                                    color: NexusPalette.cyan.withValues(
                                      alpha: .3,
                                    ),
                                  ),
                                ]
        ...
        DecoratedBox(
          ...
          child: SizedBox(
            height: 84,
            child: InfiniteBrandMarquee(surface: surface, border: border),
          ),
        ),
        Padding(
                ...
                child: InkWell(
                  ...
                  child: Ink(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(categoryIcon(cat.id), color: iconMuted, size: 26),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          blurRadius: 28,
                          color: NexusPalette.violet.withValues(alpha: .22),
                          spreadRadius: 8,
                        ),
                      ],
                    ),
        ...
        Padding(
          ...
          child: LayoutGrid(store: store, border: border),
        ),
      ],
    );
  }
...
class LayoutGrid extends StatelessWidget {
  const LayoutGrid({super.key, required this.store, required this.border});
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      childAspectRatio: .68,
      children: featuredProducts.map((p) {
